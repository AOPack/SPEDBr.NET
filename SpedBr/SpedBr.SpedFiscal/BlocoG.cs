...
namespace SpedBr.SpedFiscal
{
    ...
    public class BlocoG
    {
        ...
        public class RegistroG110 : RegistroBaseSped
        {
            ...
            /// <summary>
            /// Valor de outros créditos a ser apropriado na apuração do ICMS, corresponde ao somatório do campo 09 do registro G126.
            /// </summary>
        ...
        public class RegistroG125 : RegistroBaseSped
        {
            ...
            /// <summary>
            /// Valor da parcela do ICMS passível de apropriação (antes da aplicação da participação percentual do valor das saídas tributadas/exportação sobre as saídas totais)
            /// </summary>
        ...
        public class RegistroG990 : RegistroBaseSped
        {
            ...
            /// </summary>
            [SpedCampos(2, "QTD_LIN_G", "N", Int32.MaxValue, 0, true)]
