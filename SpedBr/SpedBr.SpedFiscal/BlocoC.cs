...
namespace SpedBr.SpedFiscal
{
	...
	public class BlocoC
	{
		...
		public class RegistroC860 : RegistroBaseSped
		{
			...
			/// </summary>
			/// <remarks>
			///  informar o número do primeiro CF-e-SAT emitido, mesmo que cancelado, no período, pelo equipamento. 
			/// </remarks>
			...
			/// </summary>
			/// <remarks>
			/// informar o número do último CF-e-SAT emitido, mesmo que cancelado, no período, pelo equipamento. 
			/// </remarks>
